...
foreach (AR_Lang as $k => $item) {
    ...
    $attributes[] = ['label' => $item['text'] . '<img class="ms-1 mh-15px" src="https://r2.nwsoft.dev/metronic8/assets/media/flags/' . $item['long'] . '.svg">', 'value' => $model->translat[$k], 'captionOptions' => $opt1, 'contentOptions' => $opt2];
}
