...
<div class="row">
    ...
    ?>
        <div class="col-md-6">
            <?= $form->field($model, "message2[$k]")->textInput(['value' => $model->translat[$k]])->label('<img class="me-1 mh-15px" src="https://r2.nwsoft.dev/metronic8/assets/media/flags/' . $item['long'] . '.svg">' . $item['text']); ?>
        </div>
    <?php
    } ?>
</div>
