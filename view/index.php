...
foreach (AR_Lang as $k => $item) {
    ...
    $deptColumns[] = [
        'header'  => '<img class="me-1 mh-15px" src="https://r2.nwsoft.dev/metronic8/assets/media/flags/' . $item['long'] . '.svg">' . $item['text'],
                    ...
                    'buttons'        => [
                        'view'   => function ($url, $model, $key) {
                            return '<div class="menu-item">' . Html::a(
                                '<span class="menu-icon"><i class="fad fa-eye"></i></span><span class="menu-title">' . Yii::t('system', 'Detail') . '</span>',
                                'javascript:;',
                                ['data-key' => $key, 'class' => 'menu-link action-view']
                            ) . '</div>';
                        },
                        'update' => function ($url, $model, $key) {
                            return '<div class="menu-item">' . Html::a(
                                '<span class="menu-icon"><i class="fad fa-edit"></i></span><span class="menu-title">' . Yii::t('system', 'Update') . '</span>',
                                'javascript:;',
                                ['data-key' => $key, 'class' => 'menu-link action-update']
                            ) . '</div>';
                        },
                        'delete' => function ($url, $model, $key) {
                            return '<div class="menu-item">' . Html::a(
                                '<span class="menu-icon"><i class="fad fa-trash-alt"></i></span><span class="menu-title">' . Yii::t('system', 'Delete') . '</span>',
                                'javascript:;',
                                ['data-key' => $key, 'class' => 'menu-link action-delete']
                            ) . '</div>';
                        },
                    ],
                ],
